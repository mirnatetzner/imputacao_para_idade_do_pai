...
#  png("intercept_Brasil2022_selecionadas.png", width = 10000, height = 10000, res = 300)
#  replayPlot(plot_md)
#  dev.off()
...
#write.csv(padrao_missing_Brasil_select2022)
...
# Salva o gráfico
ggsave("ultimo_grafico_missing_idadepaimae_MS.png",  dpi = 300)
